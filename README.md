...
curl -sL https://github.com/SavageCore/sonarr-mkv-merger/releases/latest/download/sonarr-mkv-merger.tar.gz | tar xz
...
> To update: re-run the curl command - it replaces the files in place.
